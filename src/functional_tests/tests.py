...
class NewVisitorTest(LiveServerTestCase):
    ...
    def setUp(self):
        ...
        self.driver_service = webdriver.FirefoxService(executable_path=geckodriver_path)

        self.browser = webdriver.Firefox(service=self.driver_service)
    ...
    def test_layout_and_styling(self):
        ...
        # She starts a new list and notices the input box is nicely centered
        inputbox = self.browser.find_element(by="id", value="id_new_item")
        ...
        # Satisfied, they both go back to sllep
